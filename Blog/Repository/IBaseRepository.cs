...
public interface IBaseRepository<TEntity> where TEntity : class
{
    ...
    /// <param name="strOrderByFileds">排序字段，如name asc,age desc</param>
    /// <returns></returns>
    Task<ReturnModel<TEntity>> QueryPage(Expression<Func<TEntity, bool>> whereExpression = null, int intPageIndex = 1,
    ...
    /// <returns></returns>
    Task<ReturnModel<TResult>> QueryPageWithSelect<TResult>(Expression<Func<TEntity, bool>> whereExpression = null,
